...
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - Total CPU utilization for home-timeline-service}
    \label{fig:exp1-workload}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[blue, mark=none] table [x=xtick, y=value, col sep=comma] {Data/GET-Total-CPU.csv};
...
\label{sec:ch5-request-latency-eval}

\subsection {Default Kubernetes Autoscaler Baseline}
\label{subsec:ch5-default-algo}
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - Kubernetes Default Autoscaler Latency}
    \label{fig:exp1-default-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
            ...
            \addplot+[blue, mark=none] table [x=xtick, y=value, col sep=comma] {Data/Home-Timeline-Default-Latency-CPU.csv};
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - THPA Reactive Autoscaler Latency}
    \label{fig:exp1-reactive-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
            ...
            \addplot+[blue, mark=none] table [x=xtick, y=value, col sep=comma] {Data/Home-Timeline-Reactive-Latency-CPU.csv};
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - PPA Proactive Autoscaler Latency}
    \label{fig:exp1-proactive-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
            ...
            \addplot+[blue, mark=none] table [x=xtick, y=value, col sep=comma] {Data/Home-Timeline-Proactive-Latency-CPU.csv};
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - Hybrid Autoscaler Latency}
    \label{fig:exp1-hybrid-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
            ...
            \addplot+[blue, mark=none] table [x=xtick, y=value, col sep=comma] {Data/Home-Timeline-Hybrid-Latency-CPU.csv};
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - Autoscaler CPU Workload Distribution Comparison}
    \label{fig:exp1-cpu-avg-dist}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
            ...
            \addplot+[Goldenrod, mark=none] table [x=xtick, y=value, col sep=comma] {Data/Home-Timeline-CPU-Usage-Proactive.csv};
            ...
            \addlegendimage{line width=0.3mm, dashed, color=red}
            \addlegendentry{Ideal Workload Distribution}
        \end{axis}
    \end{tikzpicture}
\end{minipage}
\end{center}
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment I - SLA Violation Percentages}
    \label{fig:exp1-sla-violation-bar}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
