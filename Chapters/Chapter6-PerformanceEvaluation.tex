...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - Total CPU utilization for compose-post-service}
    \label{fig:exp2-workload}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - Kubernetes Default Autoscaler Latency}
    \label{fig:exp2-default-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - THPA Reactive Autoscaler Latency}
    \label{fig:exp2-reactive-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - PPA Proactive Autoscaler Latency}
    \label{fig:exp2-proactive-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - Hybrid Autoscaler Latency}
    \label{fig:exp2-hybrid-k8s}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - Autoscaler CPU Workload Distribution Comparison}
    \label{fig:exp2-cpu-avg-dist}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
...
\begin{center}
\begin{minipage}{\linewidth}
    \captionof{figure}{Experiment II - SLA Violation Percentages}
    \label{fig:exp2-sla-violation-bar}
    \begin{tikzpicture}
        \begin{axis}[
            height=0.4\linewidth,
