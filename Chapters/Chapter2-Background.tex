...
\suhrid{TODO: Fix LSTM cell architecture image}
%\begin{figure}[htb]
%    \centering
%    \caption{LSTM Cell Architecture}
%    \includegraphics[width=.6\linewidth]{Figures/LSTM-Cell-Architecture.png}
