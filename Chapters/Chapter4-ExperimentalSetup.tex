...
\suhrid{Discuss a bit more on why these values were chosen. Talk about how larger learning rate means less accuracy, but smaller means more training epochs required, more training epochs means training takes too long, etc.}
